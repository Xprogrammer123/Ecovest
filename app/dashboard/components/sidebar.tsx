...
const Sidebar = () => {
  ...
  return (
    <aside className="w-72 bg-white rounded-2xl ml-4 h-screen flex flex-col py-8 ml-6 mt-6 ">
      <h1 className="text-[#426b1f] text-xl font-extrabold mb-10 ml-10">
        ECOVEST
      </h1>
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-80 bg-white rounded-2xl ml-4 h-screen flex flex-col py-8 ml-6 mt-6 ">
      <h1 className="text-base text-4xl font-extrabold mb-10 ml-10">ECOVEST</h1>
